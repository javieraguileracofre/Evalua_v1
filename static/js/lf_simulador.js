  ...
  function init(cfg) {
    ...
    function payloadSim() {
      ...
      return {
        ...
        gps_monto: parseNum(document.getElementById("gps_monto") && document.getElementById("gps_monto").value),
        financia_gps: (document.getElementById("financia_gps") || {}).value === "true",
        gastos_administrativos: parseNum(document.getElementById("gastos_administrativos") && document.getElementById("gastos_administrativos").value),
        financia_gastos_admin: (document.getElementById("financia_gastos_admin") || {}).value === "true",
