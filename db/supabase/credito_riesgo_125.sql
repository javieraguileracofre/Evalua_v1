...
-- Corrige error 500 en /comercial/credito-riesgo/* por columnas v2 faltantes.
-- Requiere parches 101 y 110 ya aplicados.
-- Equivalente a db/psql/125_credito_riesgo_empresarial.sql
...
(
    ...
    '{"uf_referencia_clp": 38000, "pyme_ventas_max_uf": 25000, "pyme_trabajadores_max": 49, "mediana_ventas_max_uf": 100000, "mediana_trabajadores_max": 199, "sectores_alto_riesgo": ["construccion", "retail", "transporte"]}'::jsonb,
    'Clasificación automática PYME / Mediana / Gran Empresa.'
),
(
    'ponderaciones_pyme_v1',
    '{"capacidad_pago": 0.30, "historial_pago": 0.25, "endeudamiento": 0.10, "liquidez_flujo": 0.20, "antiguedad": 0.05, "garantias": 0.05, "macro_sectorial": 0.05}'::jsonb,
    'Pesos score segmento PYME.'
),
(
    'ponderaciones_mediana_v1',
    '{"capacidad_pago": 0.20, "historial_pago": 0.20, "endeudamiento": 0.20, "liquidez_flujo": 0.15, "antiguedad": 0.05, "garantias": 0.10, "macro_sectorial": 0.10}'::jsonb,
    'Pesos score Mediana Empresa.'
),
(
    'ponderaciones_gran_v1',
    '{"capacidad_pago": 0.15, "historial_pago": 0.15, "endeudamiento": 0.25, "liquidez_flujo": 0.15, "antiguedad": 0.05, "garantias": 0.10, "macro_sectorial": 0.15}'::jsonb,
    'Pesos score Gran Empresa.'
),
(
    'documentos_por_segmento_v1',
    '{"PYME": ["CARPETA_TRIBUTARIA", "IVA_F29", "BALANCE", "CERTIFICADO_DEUDA", "ESTADOS_FINANCIEROS", "DECLARACION_RENTA"], "MEDIANA": ["CARPETA_TRIBUTARIA", "IVA_F29", "BALANCE", "ESTADOS_FINANCIEROS", "DECLARACION_RENTA", "CERTIFICADO_DEUDA", "DOCUMENTOS_SOCIETARIOS", "GARANTIAS"], "GRAN_EMPRESA": ["CARPETA_TRIBUTARIA", "IVA_F29", "BALANCE", "ESTADOS_FINANCIEROS", "DECLARACION_RENTA", "CERTIFICADO_DEUDA", "DOCUMENTOS_SOCIETARIOS", "GARANTIAS", "EEFF_CONSOLIDADOS", "COVENANTS", "INFORME_DICOM"], "labels": {"CARPETA_TRIBUTARIA": "Carpeta tributaria SII", "IVA_F29": "Formulario IVA F29", "BALANCE": "Balance general", "ESTADOS_FINANCIEROS": "Estados financieros", "DECLARACION_RENTA": "Declaración de renta (F22)", "CERTIFICADO_DEUDA": "Certificado de deuda CMF", "DOCUMENTOS_SOCIETARIOS": "Documentos societarios", "GARANTIAS": "Garantías", "EEFF_CONSOLIDADOS": "EEFF consolidados", "COVENANTS": "Covenants", "INFORME_DICOM": "Informe DICOM (placeholder)"}}'::jsonb,
    'Checklist documental por segmento.'
),
(
    'atribuciones_comite_v1',
    '{"PYME": {"hasta_clp": 50000000, "nivel": "ANALISTA_SENIOR"}, "MEDIANA": {"hasta_clp": 300000000, "nivel": "COMITE_LOCAL"}, "GRAN_EMPRESA": {"hasta_clp": 2000000000, "nivel": "COMITE_CORPORATIVO"}, "sobre_limite": "COMITE_DIRECTORIO"}'::jsonb,
    'Atribuciones comité por segmento.'
)
