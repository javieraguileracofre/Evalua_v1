...
-- ============================================================
-- Seed base unificado (códigos numéricos, sin puntos)
-- ============================================================
...
-- Nota de migración: no borrar automáticamente códigos legacy con puntos.
-- Se mantienen para regularización manual controlada y trazabilidad histórica.